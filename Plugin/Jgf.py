...
async def _(event):
    ...
    if input_str == "gf":
        ...
        animation_chars = [
            ...
            "`Ruk jaa , Abhi JR teri GF ko Fuck karta hai `",
            "`Making your Gf warm 🔥`",
            "`Pressing her boobs 🤚😘`",
            ...
            "`Fucking Your GF😈😈\n\n\nYour GF's ASS🍑 Get Red\nCummed On her Mouth👅👄\n\nYour GF got Pleasure\n\nResult: Now JR Have 1 More SEX Partner 👍👍`"
        ]
